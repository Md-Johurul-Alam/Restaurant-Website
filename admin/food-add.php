        ...
        <form action="../backends/admin/food-add.php" method="post">
            ...
            <div class="row">
                ...
                <div class="col s6" style="">
						    ...
						    <input id="category" name="category" type="text" class="validate" style="color: white; width: 70%">
						    <label for="category" style="color: white;">Categories :</label>
						  </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col s6" style="">
                            <div class="input-field">
                            <input id="f_price" name="f_price" type="text" class="validate" style="color: white; width: 70%">
                            <label for="f_price" style="color: white;"><b>Food Price :</b></label>
                            </div>
                </div>
                <div class="col s6" style="">
                            <div class="input-field">
                            <input id="img" name="img" type="text" class="validate" style="color: white; width: 70%">
                            <label for="img" style="color: white;"><b>Add Image :</b></label>
                            </div>
                </div>
            </div>
