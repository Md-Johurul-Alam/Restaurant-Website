...
?>
    ...
    <div id="preloader">
		...
		<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target fixed-top" id="ftco-navbar">
            ...
            <a class="nav-link active show" href="#contact" class="nav-link"><span>Hi <?php echo $name; ?></span></a>
				</div>

				<button><a href="log_cart.php"><i class="fa-sharp fa-solid fa-cart-shopping"></i></a></button>&emsp;
        <p> <a href="logout.php" class="btn" id="logreg">Logout</a></p>
			</div>
		</nav>
          ...
          <div class="tab-pane fade active show" id="menu-starters">
            ...
            <form action="add_cart.php" method="Post">
              ...
              <div class="col-lg-4 menu-item">
                ...
                <input type="text" id="food_name" name="food_name" value="<?php echo $row['f_name']; ?>" readonly>
                
                <p class="ingredients">
                  <?php echo $row['f_des']; ?>
                </p>
                <p class="price">
                  <input type="text" id="food_price" name="food_price" value="<?php echo $row['f_price']; ?>" readonly>
                </p>
                 
                 <button type="submit" class="btn" id="a" name="sa">Add to cart</button>
              </div><!-- Menu Item -->
              <?php
                }
              } else {
